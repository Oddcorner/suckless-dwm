...
static const double activeopacity   = 0.55f;     /* Window opacity when it's focused (0 <= opacity <= 1) */
...
static const char col_pink[]        = "#ffd1dc";
static const char col_darkpink[]    = "#762B42";
static const unsigned int baralpha = 0x4f;
static const unsigned int borderalpha = OPAQUE;
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_pink, col_gray, col_gray3 },
	[SchemeSel]  = { col_pink, col_black,  col_pink  },
	/*               fg         topbar col   border   */
};
